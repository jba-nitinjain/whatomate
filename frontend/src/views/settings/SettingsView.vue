...
import ChatRepairPanel from "@/components/settings/ChatRepairPanel.vue";
...
const settingsTabColumns = computed(() =>
  isSuperAdmin.value ? "grid-cols-4" : "grid-cols-3",
);
    ...
    <ScrollArea class="flex-1">
      <div class="p-6 space-y-4 max-w-4xl mx-auto">
        <Tabs default-value="general" class="w-full">
          <TabsList
            :class="[
              'grid w-full mb-6 bg-white/[0.04] border border-white/[0.08] light:bg-gray-100 light:border-gray-200',
              settingsTabColumns,
            ]"
          >
            <TabsTrigger
                    ...
                    <Select v-model="generalSettings.default_timezone">
                      ...
                      >
                        ...
                        <SelectItem
                          value="Asia/Kolkata"
                          class="text-white/70 focus:bg-white/[0.08] focus:text-white light:text-gray-700 light:focus:bg-gray-100"
                          >India Standard Time (IST)</SelectItem
                        >
                        <SelectItem
          ...
          <TabsContent v-if="isSuperAdmin" value="chat-repair">
            <ChatRepairPanel />
          </TabsContent>
        </Tabs>
      </div>
